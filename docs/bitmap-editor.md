...
<div class="ehmtx-tool-container" style="padding: 10px !important;">
    <div class="editor-layout">
        <div class="picker-sidebar">
            <div id="iroPicker"></div>
            <div class="color-inputs" style="display: flex; gap: 5px; justify-content: center;">
            ...
            <div style="display: flex; gap: 5px; width: 100%; margin-top: 10px;">
                <button class="md-button md-button--primary" style="flex: 1; padding: 0 5px; font-size: 12px; min-width: 0;" onclick="window.setEditorMode(8, 8)">8x8</button>
                <button class="md-button md-button--primary" style="flex: 1; padding: 0 5px; font-size: 12px; min-width: 0;" onclick="window.setEditorMode(32, 8)">32x8</button>
            </div>
